...
import { IExperiencesTimelineItem } from "../../interfaces/IExperiencesTimelineItem";

export default function ExperiencesTimelineItem({time, side, color, children}: IExperiencesTimelineItem) {
                    ...
                    side === 'left' ? (
                        <div className="columns timeline">
                            ...
                            <div className="column left is-6 has-text-right">
                                <div className="arrow arrow-right is-hidden-mobile"/>
                        ...
                        <div className="columns timeline">
                            ...
                            <div className="column right is-6 has-text-left">
                                <div className="arrow arrow-left is-hidden-mobile"/>
